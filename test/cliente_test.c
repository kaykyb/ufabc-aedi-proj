...
int main(int argc, char* argv[]) {
    if (strcmp(argv[1], "criacao") == 0) teste_criacao();
    else if (strcmp(argv[1], "idade") == 0) teste_atualiza_idade();
    else if (strcmp(argv[1], "cnh") == 0) teste_atualiza_cnh();
    else if (strcmp(argv[1], "inadimplencia") == 0) teste_atualiza_inadimplencia();
    else if (strcmp(argv[1], "acidentes") == 0) teste_atualiza_acidentes();
    else if (strcmp(argv[1], "gastos") == 0) teste_atualiza_gastos();
    else if (strcmp(argv[1], "dias") == 0) teste_atualiza_dias();
    else {
